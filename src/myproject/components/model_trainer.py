    ...
    def initiate_model_trainer(self, train_arr, test_arr):
        try:
            ...
            for model in model_name:
                if best_model_name in model:
                    actual_model = actual_model + model

            bests_params = params[actual_model]

            mlflow.set_tracking_uri("https://dagshub.com/Siddharth0207/victus.mlflow")
            ...
            with mlflow.start_run():
                ...
                mlflow.log_params(bests_params)
